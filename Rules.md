...
### People’s choice
All the photos will be up for voting by the campus community. At the end of the competition, the one (or more, see below) most voted images will be declared as winner.
### Judges’ choice
...
## How to participate
 1. One should have an ncbs intranet account.
 2. Go to https://intranet.ncbs.res.in/user and login to your account. Please note that one cannot upload photos without logging in. Go to Photography page after logging in. (https://intranet.ncbs.res.in/photography)
 ...
 4. Click on ‘upload your photo’, to submit your entries. The current size limit to each photo is 5 MB. One must assign an appropriate caption to their image. The uploaded photo will be automatically submitted to the current theme. There is also an optional 'description' field for each submission. Though not mandatory, it shall be used to convey the message/idea in more detail, if needed.
  ...
  * If a photo is shortlisted by the people or the judges, the participant should be able to send a high resolution unedited image of the same. Original image SHOULD include all the metadata. Images without any metadata will not be accepted for the competition.
  ...
  * Use of watermark is acceptable, but discouraged. If you insist on using one, please use it non-destructively and subtly. Proper image credits will be given when your photo is printed, framed or displayed on campus e-screens.
  ...
  * An entry that is a winner of any previous competition (in-house as well as elsewhere) should not be submitted.
...
### Number of winners
Total number of winners will be decided based on number of entries in the contest. There will be 1 winner per 15 entries or 2 (whichever is maximum). However, if there is a tie amongst the winners, number of winners might increase/decrease accordingly. The decision (regarding the number of winners per contest) made by the organisers shall be final. When cash prizes are instituted (insead of awarding framed photographs, the number of winners are restrcited to 3. More details in Cash Prizes section)
### Guest uploads 
...
As per our rules and regulations, a maximum of 3 photos are allowed per theme per participant. It is participant’s responsibility to check how many photos they are uploading. As photographers’ names are hidden in voting and uploading phase, it is not possible for organisers to detect and notify users who have uploaded more than 3 photos. If any photographer has uploaded more than 3 photos to current competition, only the first 3 photos (based on uploading timestamps) will be considered during evaluation.
### Judges’ scores
...
* If PCC is cancelled, the total award money available for JCC becomes Rs 2250, and each JCC winner will receive Rs 2250/n.




*This is the 8th revision of rules and regulations implemented from 4 March 2021.*

*Previous revisions - 2 November 2020, 8 July 2019, 3 March 2019, 10 January 2018, 4 Sep 2017, 9 March 2017, 19 Jan 2017.*
